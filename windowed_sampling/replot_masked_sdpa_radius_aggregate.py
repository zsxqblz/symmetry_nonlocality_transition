#!/usr/bin/env python
"""Aggregate masked-SDPA sliding-window radius sweep plots for local-perturbation runs."""
...
DEFAULT_RESULTS_GLOB = "dit_sliding_global_window_local_masked_sdpa_r*_L0p4_unconditional_n500"
DEFAULT_OUTPUT_DIR = PERTURB_DIR / "paper_plots" / "dit_sliding_global_window_local_masked_sdpa_unconditional_n500_radius_aggregate"
FIGSIZE = (10.5, 4.3)
LINEWIDTH = 1.7
MARKERSIZE = 4.8
DPI = 200
...
def plot_metric(
    ...
    *,
    ...
    for idx, (radius, _result_dir, rows) in enumerate(runs):
        ...
        yerr = [
            [y - low for y, low in zip(ys, lows)],
