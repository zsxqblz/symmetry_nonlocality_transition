"""
Noise sweep experiment (SD3 global attention): generate clean images, inject
...
OUTPUT_DIR = str(MODULE_DIR / "outputs" / "noise_sweep_sd3_global")
...
def build_global_pipeline(model_id: str, use_dpms: bool):
...
def run_noise_sweep(args):
    ...
    pipe = build_global_pipeline(args.model_id, args.use_dpms)
...
def parse_args():
    parser = argparse.ArgumentParser(description="Noise sweep SD3 global denoising experiment")
