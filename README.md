...
- `forward_backward/`: forward-backward experiments, plotting entrypoints,
...
We have providede all raw data in generating the plots in the manucript. Run commands below to generate plots.
